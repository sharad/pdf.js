...
/**
 * pdfjsVersion = 5.5.222
 * pdfjsBuild = d14bbc807
 */
/******/ // The require scope
...
class PDFThumbnailViewer {
  ...
  getSelectedPages() {
    return this.#selectedPages ? Array.from(this.#selectedPages).sort((a, b) => a - b) : [];
  }
}
...
const PDFViewerApplication = {
  ...
  bindEvents() {
    ...
    if (exportBtn) {
      exportBtn.addEventListener("click", () => {
        ...
        const selected = PDFViewerApplication.pdfThumbnailViewer.getSelectedPages() || [];
  ...
  async onSavePagesEditedPDF({
    ...
    this.downloadManager.download(newBytes, this._downloadUrl, this._docFilename.replace(".pdf", "_extracted.pdf"));
  },
